...
function readHeader(packet: Buffer): Header | null { return packet.length < HEADER_SIZE ? null : { packetFormat: packet.readUInt16LE(0), packetId: packet.readUInt8(5), playerCarIndex: packet.readUInt8(27) }; }
